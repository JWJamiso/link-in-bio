      ...
      <div className="flex flex-col items-center space-y-4 pt-12">
        <div>
          <img
            ...
            src="https://pbs.twimg.com/profile_images/1588707853275058176/vxVWhLC2_400x400.jpg"
          ></img>
        </div>
        <div className="text-black text-center">
          ...
          <p className="mt-2 text-base text-white">
            Software dev passionate about startups, business, and software
          </p>
        </div>
        <div className="flex space-x-4 mt-4">
          ...
          <a href="https://www.linkedin.com/in/johnwjamison/" target="_blank">
            <img className="h-8 w-8" src="/linkedin.png" />
          </a>
          <a href="https://www.instagram.com/iamjohnjamison/" target="_blank">
            <img className="h-8 w-8" src="/instagram.png" />
          </a>
        </div>
        <div className="w-full space-y-4 mt-4 mx-auto px-2">
          <LinkTile
            link="https://pcpartpicker.com/b/w38J7P"
            title="My PC Build In Depth"
          ></LinkTile>
          <LinkTile
            link="https://pcpartpicker.com/b/w38J7P"
            title="My PC Build In Depth"
